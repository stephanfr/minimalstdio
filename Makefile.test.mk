...
test : clean_test lib $(TEST_EXE)

test-coverage : clean_test lib $(COVERAGE_EXE)
	cd $(COVERAGE_OBJ_DIR)
...
$(TEST_EXE) : $(C_OBJ) $(TEST_OBJ)
	$(LD) $(C_OBJ) $(TEST_OBJ) $(LDLIBS) $(TEST_LIB) -o $(TEST_EXE)
	./$(TEST_EXE)

$(TEST_OBJ_DIR)/%.o: $(CPP_TEST_SRC_DIR)/%.cpp
	$(CC) $(INCLUDE_DIRS) $(CPP_FLAGS) $(OPTIMIZATION_FLAGS) $(TEST_CPP_FLAGS) $(CDEFINES) -c $< -o $@
